    ...
    for model_list in model_lists:
        ...
        if model_dev == "TheBloke":
            ...
            if saved_model:
                ...
                model = AutoModelForCausalLM.from_pretrained(model_list, torch_dtype=d_type, ignore_mismatched_sizes = True, qkv_mode = qkv_m, load_in_8bit=True, device_map={"": 0}, max_memory=max_memory)
            if tc_enable == True:
